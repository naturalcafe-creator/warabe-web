...
export const metadata: Metadata = {
  title: 'よくある質問 | 鹿沼辛麺 童',
  description: '鹿沼辛麺 童（わらべ）へのよくある質問。営業時間・駐車場・辛さの選び方・鳳凰チャレンジのルール・もちもち麺について。',
}
...
const faqs = [
  {
    ...
    items: [
      {
        q: '営業時間を教えてください。',
        a: '昼 11:30〜14:30（14:00 LO）、夜 17:00〜21:00（20:30 LO）です。定休日は火曜日・水曜日です。※仮の営業時間です。最新情報はInstagram（@warabe_kanuma_karamen）でご確認ください。',
      },
      {
        q: '駐車場はありますか？',
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: '特製中華麺とはどんな麺ですか？',
        a: '地元製麺所と共同開発中の、鹿沼産こんにゃくを練り込んだ唯一無二の中華麺です。スープがしっかり絡む細麺で、通常の小麦麺と比べて血糖値の上昇が緩やかです。',
      },
      {
        q: '化学調味料は使っていますか？',
