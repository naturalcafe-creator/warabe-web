...
const faqs = [
  {
    ...
    items: [
      ...
      {
        q: '場所はどこですか？',
        a: '栃木県鹿沼市末広町1916-1 WARABASE 1F（洋菓子店エトワール跡地）です。東武新鹿沼駅から徒歩15分、JR鹿沼駅から徒歩18分です。',
      },
      {
        q: 'テイクアウトはできますか？',
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: 'こんにゃく麺とはどんな麺ですか？',
        a: '鹿沼産のこんにゃくを原料とした特製麺です。もちっとした食感が特徴で、スープとよく絡みます。グルテンを含みませんが、製造過程での混入の可能性についてはスタッフへお問い合わせください。',
      },
      {
        q: '化学調味料は使っていますか？',
  ...
  },
  {
    ...
    items: [
      {
        q: '鳳凰チャレンジとは何ですか？',
        a: '制限時間15分以内にスープまで飲み干して完食すると、料金が全額無料になる激辛チャレンジです。通常料金は¥2,500です。',
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        q: '銀座コーヒーとはどんなお店ですか？',
        a: '童より徒歩約1分の姉妹店です。鹿沼市銀座通りに位置するスペシャルティコーヒーのお店で、相互クーポンをご利用いただけます。',
      },
      {
        q: '焙煎所は見学できますか？',
