          ...
          <div className="grid grid-cols-2 gap-4 mb-10 md:mb-12">
            ...
            <FadeIn delay={100}>
              <div className="bg-[#161616] border border-[#c0392b]/30 p-4 md:p-8 text-center h-full">
                ...
                <p className="text-xs text-[#bbb] mt-2 md:mt-3" style={{ fontFamily: 'var(--font-noto-serif)' }}>¥2,500</p>
              </div>
            </FadeIn>
          </div>
      ...
      <section className="py-14 md:py-24 px-6 bg-[#0a0a0a] border-y border-[#1f1f1f]">
        <div className="max-w-4xl mx-auto">
          <FadeIn className="text-center mb-10 md:mb-16">
            <p className="text-xs tracking-[0.5em] text-[#c0392b] mb-3" style={{ fontFamily: 'var(--font-noto-serif)' }}>RANKING SYSTEM</p>
            <h2 className="text-4xl font-black text-[#f0ede8] tracking-wide mb-4" style={{ fontFamily: 'var(--font-noto-serif)' }}>新童宿</h2>
            <p className="text-xs tracking-[0.3em] text-[#bbb] mb-6" style={{ fontFamily: 'var(--font-noto-serif)' }}>しんわらべじゅく</p>
            <p className="text-xs md:text-sm text-[#ddd] leading-loose max-w-xl mx-auto" style={{ fontFamily: 'var(--font-noto-serif)' }}>
              ...
              <FadeIn key={r.name} delay={i * 40}>
                <div className={`flex items-center gap-4 px-6 py-4 border transition-colors ${
                  ...
                  <div className="w-7 text-center shrink-0">
                    <span className="text-sm text-[#555]" style={{ fontFamily: 'var(--font-noto-serif)' }}>{i + 1}</span>
                  </div>
                  <div className="flex-1 flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4">
                    <div className="flex items-center gap-3 flex-wrap">
                      ...
                      <span className="text-xs text-[#777] tracking-wider" style={{ fontFamily: 'var(--font-noto-serif)' }}>{r.ruby}</span>
                      <span className="text-sm font-bold text-[#c0392b]" style={{ fontFamily: 'var(--font-noto-serif)' }}>{r.level}</span>
                    </div>
                    <p className="text-sm text-[#bbb] sm:ml-auto" style={{ fontFamily: 'var(--font-noto-serif)' }}>{r.desc}</p>
                  </div>
                </div>
              </FadeIn>
            ))}
