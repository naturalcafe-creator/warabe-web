...
const noodles = [
  ...
  },
  {
    name: '中華麺',
    tag: '共同開発中',
    desc: '地元製麺所と共同開発中。鹿沼産こんにゃくを練り込んだ唯一無二の中華麺。スープがしっかり絡む細麺。',
  },
]
...
const soups = [
  ...
  },
  {
    name: 'トマト辛麺',
    tag: 'まろやか',
    desc: 'トマトの「酸味」と「辛さ」が溶け合う絶妙な味わい。リコピンたっぷりのヘルシーなトマ辛は女性に大人気。チーズトッピングがおすすめ！',
    surcharge: '＋¥80',
  },
  {
    name: '味噌辛麺',
    tag: 'コク',
    desc: '麹由来の深みある味噌ベース。腸活効果も期待できる、体に優しくてコクのある一杯。',
    surcharge: '＋¥80',
  },
]
...
export default function MenuPage() {
  return (
    <>
      ...
      {/* マーキー */}
      <Marquee
        items={['もちもち麺', '中華麺', '元祖辛麺', 'トマト辛麺', '味噌辛麺', '化学調味料不使用', '無辛 〜 Lv.12', '栃木しゃも × 鹿沼ニラ', 'お一人様大歓迎']}
        duration={22}
      />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div>
            {[
              ...
              { name: '中華麺（こんにゃく入り）', origin: '鹿沼産', desc: '地元製麺所と共同開発中。鹿沼産こんにゃくを練り込んだ細麺。' },
